...
use crate::model::style::paint_servers::{GradientDef, GradientStop, GradientUnits, SpreadMethod};
...
/// Whether two [`crate::model::style::paint_servers::GradientLength`]s denote the same
...
fn gradient_lengths_equal(
    a: crate::model::style::paint_servers::GradientLength,
    b: crate::model::style::paint_servers::GradientLength,
) -> bool {
    use crate::model::style::paint_servers::GradientLength;
    match (a, b) {
