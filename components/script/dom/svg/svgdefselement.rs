...
#[dom_struct]
pub(crate) struct SVGDefsElement {
...
impl SVGDefsElement {
    ...
    ) -> DomRoot<SVGDefsElement> {
        Node::reflect_node_with_proto(
            cx,
            Box::new(SVGDefsElement::new_inherited(local_name, prefix, document)),
            document,
            proto,
        )
    }
...
impl VirtualMethods for SVGDefsElement {
