            ...
            if let Some(primary) = element_data.styles.get_primary() {
                ...
                let msg = format!(
                    "[SVG_STYLES] <{}>\n\
                     ...
                     \x20                stroke_linecap={:?}\n\
                     \x20                stroke_linejoin={:?}\n\
                     \x20                stroke_miterlimit={:?}\n\
                     \x20                stroke_dasharray={:?}\n\
                     \x20                stroke_dashoffset={:?}\n\
                     \x20                clip_rule={:?}\n\
                     \x20                paint_order={:?}\n\
                     \x20                text_anchor={:?}\n\
                     \x20                color_interpolation={:?}\n\
                     \x20                color_interpolation_filters={:?}\n\
                     \x20                shape_rendering={:?}\n\
                     \x20                marker_start={:?}\n\
                     \x20                marker_mid={:?}\n\
                     \x20                marker_end={:?}\n\
                     \x20 svg:           cx={:?} cy={:?} r={:?} rx={:?} ry={:?} x={:?} y={:?}\n\
                     \x20                d={:?}\n\
                     \x20                vector_effect={:?}\n\
                     \x20                flood_color={:?}\n\
                     \x20                flood_opacity={:?}\n\
                     \x20                lighting_color={:?}\n\
                     \x20                stop_color={:?} stop_opacity={:?}\n\
                     \x20                clip_path={:?}\n\
                     \x20                mask_image={:?} mask_type={:?} mask_mode={:?}\n\
                     \x20                mask_clip={:?} mask_origin={:?} mask_composite={:?}\n\
                     \x20                mask_position_x={:?} mask_position_y={:?}\n\
                     \x20                mask_repeat={:?} mask_size={:?}\n\
                     \x20 inherited_box: dominant_baseline={:?} visibility={:?}\n\
                     \x20                direction={:?} writing_mode={:?}\n\
                     \x20 box:           alignment_baseline={:?} baseline_shift={:?}\n\
                     ...
                     \x20                font_stretch={:?} font_style={:?}\n\
                     \x20                font_weight={:?}\n\
                     \x20 inherited_ui:  cursor={:?} pointer_events={:?}\n\
                     \x20 effects:       filter={:?} opacity={:?}\n\
                     \x20 position:      width={:?} height={:?}\n",
                    dangerous_style_element.local_name(),
                    isvg.fill, isvg.fill_opacity, isvg.fill_rule,
                    isvg.stroke, isvg.stroke_width, isvg.stroke_opacity,
                    isvg.stroke_linecap, isvg.stroke_linejoin,
                    isvg.stroke_miterlimit, isvg.stroke_dasharray, isvg.stroke_dashoffset,
                    isvg.clip_rule, isvg.paint_order,
                    isvg.text_anchor, isvg.color_interpolation, isvg.color_interpolation_filters, isvg.shape_rendering,
                    isvg.marker_start, isvg.marker_mid, isvg.marker_end,
                    svg.cx, svg.cy, svg.r, svg.rx, svg.ry, svg.x, svg.y,
                    svg.d, svg.vector_effect,
                    svg.flood_color, svg.flood_opacity,
                    svg.lighting_color,
                    svg.stop_color, svg.stop_opacity,
                    svg.clip_path,
                    svg.mask_image, svg.mask_type, svg.mask_mode,
                    svg.mask_clip, svg.mask_origin, svg.mask_composite,
                    svg.mask_position_x, svg.mask_position_y,
                    svg.mask_repeat, svg.mask_size,
                    inherited_box.dominant_baseline, inherited_box.visibility,
                    inherited_box.direction, inherited_box.writing_mode,
                    box_.alignment_baseline, box_.baseline_shift,
                    ...
                    font.font_stretch, font.font_style,
                    font.font_weight,
                    inherited_ui.cursor, inherited_ui.pointer_events,
                    effects.filter, effects.opacity,
                    position.width, position.height,
                );
                let _ = std::fs::OpenOptions::new()
                    .create(true)
                    .append(true)
                    .open("D:\\Projects\\servo\\svg_styles.log")
